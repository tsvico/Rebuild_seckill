  ...
  <div class="detail-container">
    <div>
      <el-steps :active="formatStepStatus(order.status)" finish-status="success" align-center>
        <el-step title="查看订单" :description="formatTime(order.createTime)"></el-step>
    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div style="margin-top: 20px">
        <i class="el-icon-eleme" style="color: #606266"></i>
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="4" class="table-cell">{{user.id}}</el-col>
          <el-col :span="4" class="table-cell">{{order.status | formatStatus}}</el-col>
          <el-col :span="4" class="table-cell">{{order.orderChannel | formatSourceType}}</el-col>
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="6" class="table-cell">{{user.id}}</el-col>
          <el-col :span="6" class="table-cell">27xxxx</el-col>
          <el-col :span="6" class="table-cell">山东省xx市xx</el-col>
        </el-row>
      </div>
      <div style="margin-top: 20px">
        <i class="el-icon-eleme" style="color: #606266"></i>
      ...
      <el-table
        ...
        <el-table-column label="商品图片" width="120" align="center">
          <template slot-scope="scope">
            <img :src="scope.row.goodsImg | baseImg" style="height: 80px">
          </template>
        </el-table-column>
        ...
        <el-table-column label="原价/秒杀价" width="120" align="center">
          <template slot-scope="scope">
            <p>价格：￥{{scope.row.goodsPrice}}</p>
            <p>货号：{{scope.row.miaoshaPrice}}</p>
          </template>
        </el-table-column>
      ...
      <div style="float: right;margin: 20px">
        <template slot-scope="scope">
        合计：<span class="color-danger">￥{{scope.row.miaoshaPrice}}</span>
        </template>
      </div>
    </el-card>
...
<script>
  import {getOrderDetail,updateReceiverInfo,updateMoneyInfo,closeOrder,updateOrderNote,deleteOrder} from '@/utils/api/order';
  import LogisticsDialog from '@/views/admin/oms/order/components/logisticsDialog';
    ...
    created() {
      ...
      getOrderDetail(this.id).then(response => {
        if(response.data.code === 0){
          ...
          this.goods.push(response.data.data.goods);
        }else{
